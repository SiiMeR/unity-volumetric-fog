...
public class VolumetricFog : SceneViewFilter {
    ...
    [SerializeField] private Color _SunDirColor;
    [SerializeField] private Color _SunOppositeColor;
    ...
    private float m_FarClipMax = 100f;
    
    private float nearClip { get { return Mathf.Max(0, m_NearClip); }}
    private float farClip { get { return Mathf.Min(CurrentCamera.farClipPlane, m_FarClipMax); }}
